...
/***/ "./src/components/_layout/header/header.js":
/*!*************************************************!*\
  !*** ./src/components/_layout/header/header.js ***!
  \*************************************************/
...
var showSearchMobile = function showSearchMobile() {
  var btn = document.querySelector('.js--search-mobile');
  var search = document.querySelector('.js--search');
  var close = document.querySelector('.js--search-mobile-close');
...
/***/ "./src/components/app-overlay/overlay.js":
/*!***********************************************!*\
  !*** ./src/components/app-overlay/overlay.js ***!
  \***********************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
var showModal = function showModal() {
  var btn = document.querySelectorAll('[data-show-modal]');
  if (btn.length == 0) return;
  btn.forEach(function (elem) {
    var overlay = document.querySelector("." + elem.getAttribute('data-show-modal'));
    if (!overlay) return;
    var close = overlay.querySelector('.overlay-close');
    var notshow = elem.querySelectorAll('[data-notshow-modal]');
...
var showAccordion = function showAccordion() {
  var wrapper = document.querySelectorAll(".js--accordion");
  if (wrapper.length === 0) return;
  wrapper.forEach(function (el) {
    var wrap = el.querySelectorAll(".js--accordion-wrap");
...
/* harmony default export */ __webpack_exports__["default"] = (showAccordion);

/***/ }),

/***/ "./src/components/promocodes/promocode.js":
/*!************************************************!*\
  !*** ./src/components/promocodes/promocode.js ***!
  \************************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "filterPromocodes": function() { return /* binding */ filterPromocodes; },
/* harmony export */   "showMore": function() { return /* binding */ showMore; },
/* harmony export */   "showPromo": function() { return /* binding */ showPromo; }
/* harmony export */ });
var filterPromocodes = function filterPromocodes() {
  var wrap = document.querySelectorAll('.js--filter');
  if (wrap.length == 0) return;
  wrap.forEach(function (elem) {
    var element = elem.querySelectorAll('.js--filter-btn');
    var content = elem.querySelectorAll('.js--filter-content');
    if (element.length == 0 || content.length == 0) return;
    element.forEach(function (item) {
      var filter = 'all';
      item.addEventListener('click', function () {
        element.forEach(function (em) {
...
var changeBottomBorder = function changeBottomBorder(items) {
...
var showPromo = function showPromo() {
  var btn = document.querySelectorAll('.js--promo-btn');
  if (btn.length == 0) return;
  btn.forEach(function (elem) {
    var promo = elem.querySelector('.js--promo');
    var text = elem.querySelector('.js--promo-text');
    elem.addEventListener('click', function () {
...
var showMore = function showMore() {
  var wrap = document.querySelectorAll('.js--show-more');
  if (wrap.length == 0) return;
  wrap.forEach(function (element) {
    var btn = element.querySelector('.js--show-more-btn');
    var text = element.querySelector('.js--show-more-content');
    var plus = null;
    if (btn.querySelector('.plus')) plus = btn.querySelector('.plus');
    if (!btn || !text) return;
    var heightStart = text.clientHeight;
    ...
    btn.addEventListener('click', function () {
      ...
      if (text.classList.contains('active')) {
        ...
        if (plus) plus.classList.remove('minus');
      } else {
        text.classList.add('active');
        btn.classList.add('active');
        text.style.setProperty('max-height', text.scrollHeight + 'px');
        if (plus) plus.classList.add('minus');
      }
    });
  });
};
...
var changeReview = function changeReview() {
  var reviews = document.querySelectorAll('.js--reviews');
  if (reviews.length == 0) return;
  reviews.forEach(function (elems) {
    var review = elems.querySelectorAll('.js--review');
...
/* harmony default export */ __webpack_exports__["default"] = (changeReview);

/***/ }),

/***/ "./src/components/shops/shop.js":
/*!**************************************!*\
  !*** ./src/components/shops/shop.js ***!
  \**************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
var removeBorder = function removeBorder(items, count) {
  ...
  } else for (var _i = items.length - 1; _i >= items.length - items.length % count; _i--) {
    items[_i].style.borderBottom = 'none';
  }
};
...
__webpack_require__.r(__webpack_exports__);
var changeBtn = function changeBtn(heightStart, content, btn) {
...
var setMaxHeight = function setMaxHeight(content, heightStart) {
  content.style.setProperty('max-height', heightStart + 'px');
};
var setPropertyClamp = function setPropertyClamp(content_txt) {
  var row = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
  if (!content_txt) return;
  if (row) content_txt.style.setProperty('-webkit-line-clamp', row);else content_txt.style.removeProperty('-webkit-line-clamp');
};
var lookMore = function lookMore() {
  var wrapper = document.querySelectorAll('.js--look-more');
  if (wrapper.length === 0) return;
  wrapper.forEach(function (wrap) {
    var btn = wrap.querySelector('.js--look-more--btn');
    var content = wrap.querySelector('.js--look-more--content');
    var content_txt = content.querySelector('p');
    var row = 3;
    if (wrap.hasAttribute('data-more-content-row')) row = wrap.getAttribute('data-more-content-row');
    var heightStart = 19 * row + 2;
...
/* harmony default export */ __webpack_exports__["default"] = (lookMore);
...
/* harmony import */ var _components_layout_header_header_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/_layout/header/header.js */ "./src/components/_layout/header/header.js");
/* harmony import */ var _components_shops_shop_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/shops/shop.js */ "./src/components/shops/shop.js");
/* harmony import */ var _components_review_review_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/review/review.js */ "./src/components/review/review.js");
/* harmony import */ var _components_app_overlay_overlay_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/app-overlay/overlay.js */ "./src/components/app-overlay/overlay.js");
/* harmony import */ var _components_promocodes_promocode_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/promocodes/promocode.js */ "./src/components/promocodes/promocode.js");
/* harmony import */ var _components_burger_burger_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../components/burger/burger.js */ "./src/components/burger/burger.js");
/* harmony import */ var _components_faq_faq_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../components/faq/faq.js */ "./src/components/faq/faq.js");
/* harmony import */ var _components_lookMore_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/lookMore.js */ "./src/js/components/lookMore.js");
...
window.addEventListener('load', function () {
  ...
  (0,_components_promocodes_promocode_js__WEBPACK_IMPORTED_MODULE_6__.filterPromocodes)();
  (0,_components_promocodes_promocode_js__WEBPACK_IMPORTED_MODULE_6__.showPromo)();
  (0,_components_promocodes_promocode_js__WEBPACK_IMPORTED_MODULE_6__.showMore)();
  (0,_components_burger_burger_js__WEBPACK_IMPORTED_MODULE_7__["default"])();
  (0,_components_faq_faq_js__WEBPACK_IMPORTED_MODULE_8__["default"])();
  (0,_components_lookMore_js__WEBPACK_IMPORTED_MODULE_9__["default"])();
  new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".shop-swiper", {
    slidesPerView: 1,
  ...
  var copyText = function copyText() {
    var wrap = document.querySelectorAll('.js--copy');
    if (wrap.length == 0) return;
    wrap.forEach(function (elem) {
      var btn = elem.querySelector('.js--copy-btn');
      var input = elem.querySelector('.js--copy-input');
      if (!btn || !input) return;
      btn.addEventListener('click', function () {
        input.select();
